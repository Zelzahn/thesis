...
% Reduce text size of all codefragments
...
% Allows showing certain pages in landscape mode
\usepackage{rotating}
...
\include{chapters/3_abstract/dutch}
\include{chapters/3_abstract/english}
\includepdf[pages={1-}]{chapters/4_extended_abstract/dutch.pdf}
\includepdf[pages={1-}]{chapters/4_extended_abstract/main.pdf}
% \include{chapters/4_extended_abstract/dutch}
\tableofcontents\newpage
\listoffigures\newpage
\listoftables\newpage
...
% \setcounter{page}{1}
\include{chapters/7_corpus/1_background.tex}


% Vanaf hier mag er geen nieuwe kennis meer geïntroduceerd worden!
\include{chapters/7_corpus/2_architecture_and_standard.tex}
\include{chapters/7_corpus/3_implementations.tex}
\include{chapters/7_corpus/4_evaluation.tex}
