...
% TODO: Dit aanvullen wanneer Merlijn op Dan geantwoord heeft.
% https://github.com/WebAssembly/wasi-i2c/pull/9
% In case of ambiguity the I2C standard should be followed.

% TODO: Verwijzen naar Zephyr I2C API
% https://github.com/WebAssembly/wasi-i2c/issues/6
